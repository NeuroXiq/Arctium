...
namespace Arctium.Standards.Connection.Tls.Tls13.Protocol.Helpers
{
    /// <summary>
    ...
    internal static class GreaseInject
    {
        ...
        public static void ForServer(object msg, ExtensionServerConfigGREASE config)
        {
            ...
            else if (msg is CertificateRequest) GreaseInject.Server(msg as CertificateRequest, config);
            else if (msg is NewSessionTicket) GreaseInject.Server(msg as NewSessionTicket, config);
