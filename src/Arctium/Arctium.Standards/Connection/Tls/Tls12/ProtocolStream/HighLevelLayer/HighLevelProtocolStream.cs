...
using Arctium.Standards.Connection.Tls.ProtocolStream.RecordsLayer.RecordsLayer11;
using Arctium.Standards.Connection.Tls.Tls12.CryptoConfiguration;
using Arctium.Standards.Connection.Tls.Protocol.BinaryOps.Builder.HandshakeBuilders;

namespace Arctium.Standards.Connection.Tls.ProtocolStream.HighLevelLayer
{
