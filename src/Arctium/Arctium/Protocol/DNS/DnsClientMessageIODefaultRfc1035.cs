...
{
    public class DnsClientMessageIODefaultRfc1035 : IDnsClientMessageIO
    {
        ...
        public DnsClientMessageIODefaultRfc1035(
        ...
        public static DnsClientMessageIODefaultRfc1035 CreateDefault()
        {
