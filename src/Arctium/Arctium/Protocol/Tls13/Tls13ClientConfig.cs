...
namespace Arctium.Protocol.Tls13
{
    public class Tls13ClientConfig
    {
        ...
        static readonly SignatureScheme[] DefaultSignatureSchemes = Enum.GetValues<SignatureScheme>();
        static readonly CipherSuite[] DefaultCipherSuites = Enum.GetValues<CipherSuite>();
        static readonly NamedGroup[] DefaultNamedGroupsToSendInClientHello1 = new NamedGroup[] { NamedGroup.X25519 };
        ...
        static readonly ExtensionClientConfigSupportedGroups DefaultExtensionSupportedGroups = new ExtensionClientConfigSupportedGroups(Enum.GetValues<NamedGroup>());
        ...
        public void ThrowIfInvalidState()
        {
            ...
            var supportedGroups = ExtensionSupportedGroups.InternalNamedGroups;
