...
namespace Arctium.Connection.Tls.CryptoFunctions
{
    class KeyGenerator
    {
        ...
        public Tls11Keys GenerateKeys(KeyGenerationSeed keySeed)
        {
            ...
            Tls11Keys keys = PartitionToKeys(keyBlock, hashSize, keySize);
        ...
        private Tls11Keys PartitionToKeys(byte[] keyBlock, int hashSize, int keySize)
        {
