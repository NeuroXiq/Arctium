...
namespace Arctium.Connection.Tls.Protocol.BinaryOps.Formatter.HandshakeFormatters.ExtensionsFormatters
{
    ...
    public class ExtensionsFormatter
    {
        ...
        //     on 'offset'in parameter     |                                                         |----this block is generated by formatter (check dictionary in this class above)
        //                                 |                                                         |------------------------|   
        ...
        public int GetBytes(byte[] buffer, int offset, HandshakeExtension[] extensions)
        {
            ...
            // 2 + 2 + 2 == first extension type (2 bytes) + first extensions length ( 2 bytes )
            ...
            //first 2 bytes of extensiosn are length of all formatter extensionss vectors 
