 ...
 * TLS 1.3 - Client - Handshake Client Authentication
 * 
 * How to configure Handshake Client Authentication
 * 
 * Can be tested with Arctium TLS 1.3 Server or any server that requires authentication
 */
...
{
    class HSClientAuth : ClientConfigHandshakeClientAuthentication
    {
    ...
    internal class MainProgram
    {
        static void Main()
        {
            ...
            // configure HS auth
            context.Config.ConfigureHandshakeClientAuthentication(new HSClientAuth());
