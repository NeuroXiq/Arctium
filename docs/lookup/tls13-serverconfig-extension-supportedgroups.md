 ...
 * TLS 1.3 - 
 * Example demonstrates how to configure Supported Groups
 * 
 */
...
namespace ConsoleAppTest
{
    internal class MainProgram
    {
        ...
        static void StartServer()
        {
            ...
            /*  Configuration for supported groups */
            // Server will use only x25519 and x448
            // Any other group will not be accepted
            var supportedGroups = new NamedGroup[] { NamedGroup.X25519, NamedGroup.Xx448 };
            var supportedGroupsConfig = new ExtensionServerConfigSupportedGroups(supportedGroups);
            serverContext.Config.ConfigueExtensionSupportedGroups(supportedGroupsConfig);
